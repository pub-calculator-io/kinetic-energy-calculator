...
Version: 1.0.0
Author: Kinetic Energy Calculator / www.calculator.io
...
function display_calcio_ci_kinetic_energy_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_kinetic_energy_calculator', 'display_calcio_ci_kinetic_energy_calculator' );